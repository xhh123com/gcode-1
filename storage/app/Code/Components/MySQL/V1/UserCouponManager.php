...
class UserCouponManager
{
    ...
    * 2020-02-02 04:07:18
    ...
    public static function getListByCon($con_arr, $is_paginate)
    {
        ...
        if (array_key_exists('used_time', $con_arr) && !Utils::isObjNull($con_arr['used_time'])) {
            $infos = $infos->where('used_time', '=', $con_arr['used_time']);
        }
    ...
    * 2020-02-02 04:07:18
    ...
    public static function setInfo($info, $data)
    {
        ...
        if (array_key_exists('used_time', $data)) {
                $info->used_time = $data['used_time'];
            }
