...
class CompanyManager
{
    ...
    */
    ...
    {
        $info = Company::withTrashed()->where('id', $id)->first();
        return $info;
    }
    ...
    */
    public static function deleteById($id)
    {
        ...
        $result = $info->delete();
        RedisManager::del("company:" . $info->id);
        return $result;
    }
    ...
    * 2020-01-03 02:14:38
    ...
    public static function getListByCon($con_arr, $is_paginate)
    {
        ...
        if (array_key_exists('website_url', $con_arr) && !Utils::isObjNull($con_arr['website_url'])) {
            $infos = $infos->where('website_url', '=', $con_arr['website_url']);
        }
        ...
        if (array_key_exists('ewm_img', $con_arr) && !Utils::isObjNull($con_arr['ewm_img'])) {
            $infos = $infos->where('ewm_img', '=', $con_arr['ewm_img']);
        }
    ...
    * 2020-01-03 02:14:38
    ...
    public static function setInfo($info, $data,$level=0)
    {
        ...
        if (array_key_exists('website_url', $data)) {
                $info->website_url = $data['website_url'];
            }
        ...
        if (array_key_exists('ewm_img', $data)) {
                $info->ewm_img = $data['ewm_img'];
            }
