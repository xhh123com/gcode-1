...
class RecipeIngredientManager
{
    ...
    * 2020-02-02 04:07:16
    ...
    {
        $info = RecipeIngredient::where('id', $id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = RecipeIngredient::withTrashed()->where('id', $id)->first();
        return $info;
    }
    ...
    */
    public static function deleteById($id)
    {
        ...
        $result = $info->delete();
        RedisManager::del("recipe_ingredient:" . $info->id);
        return $result;
    }
    ...
    * 2020-02-02 04:07:16
    ...
    public static function getListByCon($con_arr, $is_paginate)
    {
        ...
        if (array_key_exists('recipe_id', $con_arr) && !Utils::isObjNull($con_arr['recipe_id'])) {
            $infos = $infos->where('recipe_id', '=', $con_arr['recipe_id']);
        }
        ...
        if (array_key_exists('rule', $con_arr) && !Utils::isObjNull($con_arr['rule'])) {
            $infos = $infos->where('rule', '=', $con_arr['rule']);
        }
