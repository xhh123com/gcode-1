...
class DeliveryManager
{
    ...
    */
    ...
    {
        $info = Delivery::withTrashed()->where('id', $id)->first();
        return $info;
    }
    ...
    */
    public static function deleteById($id)
    {
        ...
        $result = $info->delete();
        RedisManager::del("delivery:" . $info->id);
        return $result;
    }
    ...
    * 2020-02-02 04:07:10
    ...
    public static function getListByCon($con_arr, $is_paginate)
    {
        ...
        if (array_key_exists('principal', $con_arr) && !Utils::isObjNull($con_arr['principal'])) {
            $infos = $infos->where('principal', '=', $con_arr['principal']);
        }
