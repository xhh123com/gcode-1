...
class ScoreRecordManager
{
    ...
    */
    ...
    {
        $info = ScoreRecord::withTrashed()->where('id', $id)->first();
        return $info;
    }
    ...
    */
    public static function deleteById($id)
    {
        ...
        $result = $info->delete();
        RedisManager::del("score_record:" . $info->id);
        return $result;
    }
    ...
    * 2020-01-03 02:14:44
    ...
    public static function getListByCon($con_arr, $is_paginate)
    {
        ...
        if (array_key_exists('record', $con_arr) && !Utils::isObjNull($con_arr['record'])) {
            $infos = $infos->where('record', '=', $con_arr['record']);
        }
