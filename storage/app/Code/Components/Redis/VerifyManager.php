...
class VerifyManager
{
    ...
    */
    ...
    {
        $info = Verify::withTrashed()->where('id', $id)->first();
        return $info;
    }
    ...
    */
    public static function deleteById($id)
    {
        ...
        $result = $info->delete();
        RedisManager::del("verify:" . $info->id);
        return $result;
    }
    ...
    * 2020-02-02 04:07:19
    ...
    public static function getListByCon($con_arr, $is_paginate)
    {
        ...
        if (array_key_exists('phonenum_prefix', $con_arr) && !Utils::isObjNull($con_arr['phonenum_prefix'])) {
            $infos = $infos->where('phonenum_prefix', '=', $con_arr['phonenum_prefix']);
        }
    ...
    * 2020-02-02 04:07:19
    ...
    public static function setInfo($info, $data,$level=0)
    {
        ...
        if (array_key_exists('phonenum_prefix', $data)) {
                $info->phonenum_prefix = $data['phonenum_prefix'];
            }
