...
class ShopManager
{
    ...
    */
    ...
    {
        $info = Shop::withTrashed()->where('id', $id)->first();
        return $info;
    }
    ...
    * 2020-01-03 02:14:48
    ...
    public static function getListByCon($con_arr, $is_paginate)
    {
        ...
        if (array_key_exists('monthly_sale_num', $con_arr) && !Utils::isObjNull($con_arr['monthly_sale_num'])) {
            $infos = $infos->where('monthly_sale_num', '=', $con_arr['monthly_sale_num']);
        }
    ...
    * 2020-01-03 02:14:48
    ...
    public static function setInfo($info, $data,$level=0)
    {
        ...
        if (array_key_exists('monthly_sale_num', $data)) {
                $info->monthly_sale_num = $data['monthly_sale_num'];
            }
