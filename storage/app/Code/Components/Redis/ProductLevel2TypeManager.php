...
class ProductLevel2TypeManager
{
    ...
    * 2020-01-03 02:14:43
    ...
    {
        $info = ProductLevel2Type::where('id', $id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = ProductLevel2Type::withTrashed()->where('id', $id)->first();
        return $info;
    }
    ...
    */
    public static function deleteById($id)
    {
        ...
        $result = $info->delete();
        RedisManager::del("product_level2_type:" . $info->id);
        return $result;
    }
    ...
    * 2020-01-03 02:14:43
    ...
    public static function getListByCon($con_arr, $is_paginate)
    {
        ...
        if (array_key_exists('goods_num', $con_arr) && !Utils::isObjNull($con_arr['goods_num'])) {
            $infos = $infos->where('goods_num', '=', $con_arr['goods_num']);
        }
