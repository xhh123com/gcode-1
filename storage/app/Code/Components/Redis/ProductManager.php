...
class ProductManager
{
    ...
    */
    ...
    {
        $info = Product::withTrashed()->where('id', $id)->first();
        return $info;
    }
    ...
    */
    public static function deleteById($id)
    {
        ...
        $result = $info->delete();
        RedisManager::del("product:" . $info->id);
        return $result;
    }
    ...
    * 2020-01-03 02:14:41
    ...
    public static function getListByCon($con_arr, $is_paginate)
    {
        ...
        if (array_key_exists('shop_store_ids', $con_arr) && !Utils::isObjNull($con_arr['shop_store_ids'])) {
            $infos = $infos->where('shop_store_ids', '=', $con_arr['shop_store_ids']);
        }
        ...
        if (array_key_exists('product_level1_type_id', $con_arr) && !Utils::isObjNull($con_arr['product_level1_type_id'])) {
            $infos = $infos->where('product_level1_type_id', '=', $con_arr['product_level1_type_id']);
        }
    
        if (array_key_exists('product_level2_type_id', $con_arr) && !Utils::isObjNull($con_arr['product_level2_type_id'])) {
            $infos = $infos->where('product_level2_type_id', '=', $con_arr['product_level2_type_id']);
        }
    ...
    * 2020-01-03 02:14:41
    ...
    public static function setInfo($info, $data,$level=0)
    {
        ...
        if (array_key_exists('shop_store_ids', $data)) {
                $info->shop_store_ids = $data['shop_store_ids'];
            }
        ...
        if (array_key_exists('product_level1_type_id', $data)) {
                $info->product_level1_type_id = $data['product_level1_type_id'];
            }
        
        if (array_key_exists('product_level2_type_id', $data)) {
                $info->product_level2_type_id = $data['product_level2_type_id'];
            }
