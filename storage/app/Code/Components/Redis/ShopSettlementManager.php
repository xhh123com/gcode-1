...
class ShopSettlementManager
{
    ...
    * 2020-01-03 02:14:48
    ...
    {
        $info = ShopSettlement::where('id', $id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = ShopSettlement::withTrashed()->where('id', $id)->first();
        return $info;
    }
    ...
    */
    public static function deleteById($id)
    {
        ...
        $result = $info->delete();
        RedisManager::del("shop_settlement:" . $info->id);
        return $result;
    }
    ...
    * 2020-01-03 02:14:48
    ...
    public static function getListByCon($con_arr, $is_paginate)
    {
        ...
        if (array_key_exists('bank_id', $con_arr) && !Utils::isObjNull($con_arr['bank_id'])) {
            $infos = $infos->where('bank_id', '=', $con_arr['bank_id']);
        }
    
        if (array_key_exists('bank_account', $con_arr) && !Utils::isObjNull($con_arr['bank_account'])) {
            $infos = $infos->where('bank_account', '=', $con_arr['bank_account']);
        }
        ...
        if (array_key_exists('orgCode_cert_img', $con_arr) && !Utils::isObjNull($con_arr['orgCode_cert_img'])) {
            $infos = $infos->where('orgCode_cert_img', '=', $con_arr['orgCode_cert_img']);
        }
    
        if (array_key_exists('bank_licence_img', $con_arr) && !Utils::isObjNull($con_arr['bank_licence_img'])) {
            $infos = $infos->where('bank_licence_img', '=', $con_arr['bank_licence_img']);
        }
    ...
    * 2020-01-03 02:14:48
    ...
    public static function setInfo($info, $data,$level=0)
    {
        ...
        if (array_key_exists('orgCode_cert_img', $data)) {
                $info->orgCode_cert_img = $data['orgCode_cert_img'];
            }
        
        if (array_key_exists('bank_licence_img', $data)) {
                $info->bank_licence_img = $data['bank_licence_img'];
            }
