...
class DailyCheckOrderManager
{
    ...
    * 2020-01-03 02:14:40
    ...
    {
        $info = DailyCheckOrder::where('id', $id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = DailyCheckOrder::withTrashed()->where('id', $id)->first();
        return $info;
    }
    ...
    */
    public static function deleteById($id)
    {
        ...
        $result = $info->delete();
        RedisManager::del("daily_check_order:" . $info->id);
        return $result;
    }
    ...
    * 2020-01-03 02:14:40
    ...
    public static function getListByCon($con_arr, $is_paginate)
    {
        ...
        if (array_key_exists('date_at', $con_arr) && !Utils::isObjNull($con_arr['date_at'])) {
            $infos = $infos->where('date_at', '=', $con_arr['date_at']);
        }
        ...
        if (array_key_exists('discrepancy_flag', $con_arr) && !Utils::isObjNull($con_arr['discrepancy_flag'])) {
            $infos = $infos->where('discrepancy_flag', '=', $con_arr['discrepancy_flag']);
        }
    
        if (array_key_exists('check_result', $con_arr) && !Utils::isObjNull($con_arr['check_result'])) {
            $infos = $infos->where('check_result', '=', $con_arr['check_result']);
        }
    ...
    * 2020-01-03 02:14:40
    ...
    public static function setInfo($info, $data,$level=0)
    {
        ...
        if (array_key_exists('discrepancy_flag', $data)) {
                $info->discrepancy_flag = $data['discrepancy_flag'];
            }
        
        if (array_key_exists('check_result', $data)) {
                $info->check_result = $data['check_result'];
            }
