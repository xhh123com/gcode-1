...
class ShopContractManager
{
    ...
    * 2020-01-03 02:14:47
    ...
    {
        $info = ShopContract::where('id', $id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = ShopContract::withTrashed()->where('id', $id)->first();
        return $info;
    }
    ...
    */
    public static function deleteById($id)
    {
        ...
        $result = $info->delete();
        RedisManager::del("shop_contract:" . $info->id);
        return $result;
    }
    ...
    * 2020-01-03 02:14:47
    ...
    public static function getListByCon($con_arr, $is_paginate)
    {
        ...
        if (array_key_exists('attach', $con_arr) && !Utils::isObjNull($con_arr['attach'])) {
            $infos = $infos->where('attach', '=', $con_arr['attach']);
        }
