...
class VericodeManager
{
    ...
    * 2020-01-03 02:14:54
    ...
    {
        $info = Vericode::where('id', $id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = Vericode::withTrashed()->where('id', $id)->first();
        return $info;
    }
    ...
    */
    public static function deleteById($id)
    {
        ...
        $result = $info->delete();
        RedisManager::del("vericode:" . $info->id);
        return $result;
    }
    ...
    * 2020-01-03 02:14:54
    ...
    public static function getListByCon($con_arr, $is_paginate)
    {
        ...
        if (array_key_exists('encrypt_flag', $con_arr) && !Utils::isObjNull($con_arr['encrypt_flag'])) {
            $infos = $infos->where('encrypt_flag', '=', $con_arr['encrypt_flag']);
        }
    ...
    * 2020-01-03 02:14:54
    ...
    public static function setInfo($info, $data,$level=0)
    {
        ...
        if (array_key_exists('encrypt_flag', $data)) {
                $info->encrypt_flag = $data['encrypt_flag'];
            }
