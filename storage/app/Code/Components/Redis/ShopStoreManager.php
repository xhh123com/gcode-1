...
class ShopStoreManager
{
    ...
    * 2020-01-03 02:14:49
    ...
    {
        $info = ShopStore::where('id', $id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = ShopStore::withTrashed()->where('id', $id)->first();
        return $info;
    }
    ...
    */
    public static function deleteById($id)
    {
        ...
        $result = $info->delete();
        RedisManager::del("shop_store:" . $info->id);
        return $result;
    }
    ...
    * 2020-01-03 02:14:49
    ...
    public static function getListByCon($con_arr, $is_paginate)
    {
        ...
        if (array_key_exists('city_id', $con_arr) && !Utils::isObjNull($con_arr['city_id'])) {
            $infos = $infos->where('city_id', '=', $con_arr['city_id']);
        }
        ...
        if (array_key_exists('detail_address', $con_arr) && !Utils::isObjNull($con_arr['detail_address'])) {
            $infos = $infos->where('detail_address', '=', $con_arr['detail_address']);
        }
        ...
        if (array_key_exists('business_hours', $con_arr) && !Utils::isObjNull($con_arr['business_hours'])) {
            $infos = $infos->where('business_hours', '=', $con_arr['business_hours']);
        }
        ...
        if (array_key_exists('lon', $con_arr) && !Utils::isObjNull($con_arr['lon'])) {
            $infos = $infos->where('lon', '=', $con_arr['lon']);
        }
    
        if (array_key_exists('lat', $con_arr) && !Utils::isObjNull($con_arr['lat'])) {
            $infos = $infos->where('lat', '=', $con_arr['lat']);
        }
    
        if (array_key_exists('geohash', $con_arr) && !Utils::isObjNull($con_arr['geohash'])) {
            $infos = $infos->where('geohash', '=', $con_arr['geohash']);
        }
    ...
    * 2020-01-03 02:14:49
    ...
    public static function setInfo($info, $data,$level=0)
    {
        ...
        if (array_key_exists('detail_address', $data)) {
        ...
        if (array_key_exists('geohash', $data)) {
                $info->geohash = $data['geohash'];
            }
