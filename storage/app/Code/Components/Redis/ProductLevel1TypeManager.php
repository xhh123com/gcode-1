...
class ProductLevel1TypeManager
{
    ...
    * 2020-01-03 02:14:42
    ...
    {
        $info = ProductLevel1Type::where('id', $id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = ProductLevel1Type::withTrashed()->where('id', $id)->first();
        return $info;
    }
    ...
    */
    public static function deleteById($id)
    {
        ...
        $result = $info->delete();
        RedisManager::del("product_level1_type:" . $info->id);
        return $result;
    }
