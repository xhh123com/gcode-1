...
class VericodeVerifyRecordManager
{
    ...
    * 2020-01-03 02:14:54
    ...
    {
        $info = VericodeVerifyRecord::where('id', $id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = VericodeVerifyRecord::withTrashed()->where('id', $id)->first();
        return $info;
    }
    ...
    */
    public static function deleteById($id)
    {
        ...
        $result = $info->delete();
        RedisManager::del("vericode_verify_record:" . $info->id);
        return $result;
    }
    ...
    * 2020-01-03 02:14:54
    ...
    {
        $infos = new VericodeVerifyRecord();
        ...
        if (array_key_exists('vericode_id', $con_arr) && !Utils::isObjNull($con_arr['vericode_id'])) {
            $infos = $infos->where('vericode_id', '=', $con_arr['vericode_id']);
        }
        ...
        if (array_key_exists('result_status', $con_arr) && !Utils::isObjNull($con_arr['result_status'])) {
            $infos = $infos->where('result_status', '=', $con_arr['result_status']);
        }
    ...
    * 2020-01-03 02:14:54
    ...
    public static function setInfo($info, $data,$level=0)
    {
        ...
        if (array_key_exists('vericode_id', $data)) {
                $info->vericode_id = $data['vericode_id'];
            }
        ...
        if (array_key_exists('result_status', $data)) {
                $info->result_status = $data['result_status'];
            }
