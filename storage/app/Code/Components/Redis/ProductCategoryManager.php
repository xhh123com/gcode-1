...
class ProductCategoryManager
{
    ...
    * 2020-02-02 04:07:14
    ...
    {
        $info = ProductCategory::where('id', $id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = ProductCategory::withTrashed()->where('id', $id)->first();
        return $info;
    }
    ...
    */
    public static function deleteById($id)
    {
        ...
        $result = $info->delete();
        RedisManager::del("product_category:" . $info->id);
        return $result;
    }
    ...
    * 2020-02-02 04:07:14
    ...
    public static function getListByCon($con_arr, $is_paginate)
    {
        ...
        if (array_key_exists('p_category_id', $con_arr) && !Utils::isObjNull($con_arr['p_category_id'])) {
            $infos = $infos->where('p_category_id', '=', $con_arr['p_category_id']);
        }
    ...
    * 2020-02-02 04:07:14
    ...
    public static function setInfo($info, $data,$level=0)
    {
        ...
        if (array_key_exists('p_category_id', $data)) {
                $info->p_category_id = $data['p_category_id'];
            }
