...
class UserShopClerkApplyManager
{
    ...
    * 2020-01-03 02:14:53
    ...
    {
        $info = UserShopClerkApply::where('id', $id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = UserShopClerkApply::withTrashed()->where('id', $id)->first();
        return $info;
    }
    ...
    */
    public static function deleteById($id)
    {
        ...
        $result = $info->delete();
        RedisManager::del("user_shop_clerk_apply:" . $info->id);
        return $result;
    }
    ...
    * 2020-01-03 02:14:53
    ...
    public static function getListByCon($con_arr, $is_paginate)
    {
        ...
        if (array_key_exists('audit_shop_clerk_id', $con_arr) && !Utils::isObjNull($con_arr['audit_shop_clerk_id'])) {
            $infos = $infos->where('audit_shop_clerk_id', '=', $con_arr['audit_shop_clerk_id']);
        }
    
        if (array_key_exists('audit_at', $con_arr) && !Utils::isObjNull($con_arr['audit_at'])) {
            $infos = $infos->where('audit_at', '=', $con_arr['audit_at']);
        }
        ...
        if (array_key_exists('valid_days', $con_arr) && !Utils::isObjNull($con_arr['valid_days'])) {
            $infos = $infos->where('valid_days', '=', $con_arr['valid_days']);
        }
    ...
    * 2020-01-03 02:14:53
    ...
    public static function setInfo($info, $data,$level=0)
    {
        ...
        if (array_key_exists('audit_shop_clerk_id', $data)) {
                $info->audit_shop_clerk_id = $data['audit_shop_clerk_id'];
            }
        
        if (array_key_exists('audit_at', $data)) {
                $info->audit_at = $data['audit_at'];
            }
        ...
        if (array_key_exists('valid_days', $data)) {
                $info->valid_days = $data['valid_days'];
            }
