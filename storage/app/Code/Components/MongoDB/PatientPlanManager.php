...
use App\MongoDB\Models\Doc\PatientPlanDoc;
use App\MongoDB\Models\PatientPlan;
use Illuminate\Support\Facades\DB;

//该版本Manager主要支持MongoDB的数据模型
class PatientPlanManager
{
    ...
    */
    public static function getById($_id)
    {
        ...
        $info = PatientPlan::where('_id', $_id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = PatientPlan::withTrashed()->where('_id', $_id)->first();
        return $info;
    }
    ...
    */
    public static function getListByCon($con_arr, $is_paginate, $page = 1)
    {
        ...
        if (array_key_exists('patient_plan_type', $con_arr) && !Utils::isObjNull($con_arr['patient_plan_type'])) {
        $infos = $infos->where('patient_plan_type', '=', $con_arr['patient_plan_type']);
        }
        ...
        if (array_key_exists('injection_plan_time', $con_arr) && !Utils::isObjNull($con_arr['injection_plan_time'])) {
        $infos = $infos->where('injection_plan_time', '=', $con_arr['injection_plan_time']);
        }
        ...
        if (array_key_exists('injection_status', $con_arr) && !Utils::isObjNull($con_arr['injection_status'])) {
        $infos = $infos->where('injection_status', '=', $con_arr['injection_status']);
        }
    
        if (array_key_exists('actual_injection_time', $con_arr) && !Utils::isObjNull($con_arr['actual_injection_time'])) {
        $infos = $infos->where('actual_injection_time', '=', $con_arr['actual_injection_time']);
        }
    
        if (array_key_exists('cumulative_injection_nums', $con_arr) && !Utils::isObjNull($con_arr['cumulative_injection_nums'])) {
        $infos = $infos->where('cumulative_injection_nums', '=', $con_arr['cumulative_injection_nums']);
        }
    
        if (array_key_exists('cumulative_injection_reel_nums', $con_arr) && !Utils::isObjNull($con_arr['cumulative_injection_reel_nums'])) {
        $infos = $infos->where('cumulative_injection_reel_nums', '=', $con_arr['cumulative_injection_reel_nums']);
        }
    
        if (array_key_exists('arrived_status', $con_arr) && !Utils::isObjNull($con_arr['arrived_status'])) {
        $infos = $infos->where('arrived_status', '=', $con_arr['arrived_status']);
        }
...
{
    $ref = new \ReflectionClass(PatientPlanDoc::class);
    ...
    $info->doctor_id = $data['doctor_id'];
            ...
            if (array_key_exists('patient_plan_type', $data)) {
    $info->patient_plan_type = $data['patient_plan_type'];
    }
    ...
    $info->patient_plan_time = $data['patient_plan_time'];
            ...
            if (array_key_exists('injection_plan_time', $data)) {
    $info->injection_plan_time = $data['injection_plan_time'];
    }
    ...
    $info->content = $data['content'];
            ...
            if (array_key_exists('injection_status', $data)) {
    $info->injection_status = $data['injection_status'];
    }
        
    
            if (array_key_exists('actual_injection_time', $data)) {
    $info->actual_injection_time = $data['actual_injection_time'];
    }
        
    
            if (array_key_exists('cumulative_injection_nums', $data)) {
    $info->cumulative_injection_nums = $data['cumulative_injection_nums'];
    }
        
    
            if (array_key_exists('cumulative_injection_reel_nums', $data)) {
    $info->cumulative_injection_reel_nums = $data['cumulative_injection_reel_nums'];
    }
        
    
            if (array_key_exists('arrived_status', $data)) {
    $info->arrived_status = $data['arrived_status'];
    }
