...
use App\MongoDB\Models\Doc\DoctorLoginDoc;
use App\MongoDB\Models\DoctorLogin;
use Illuminate\Support\Facades\DB;

//该版本Manager主要支持MongoDB的数据模型
class DoctorLoginManager
{
    ...
    */
    public static function getById($_id)
    {
        ...
        $info = DoctorLogin::where('_id', $_id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = DoctorLogin::withTrashed()->where('_id', $_id)->first();
        return $info;
    }
...
{
    $ref = new \ReflectionClass(DoctorLoginDoc::class);
