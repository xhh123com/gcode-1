...
use App\MongoDB\Models\Doc\PatientCaseTmplementTaskDoc;
use App\MongoDB\Models\PatientCaseTmplementTask;
use Illuminate\Support\Facades\DB;

//该版本Manager主要支持MongoDB的数据模型
class PatientCaseTmplementTaskManager
{
    ...
    */
    public static function getById($_id)
    {
        ...
        $info = PatientCaseTmplementTask::where('_id', $_id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = PatientCaseTmplementTask::withTrashed()->where('_id', $_id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $infos = new PatientCaseTmplementTask();
...
{
    $ref = new \ReflectionClass(PatientCaseTmplementTaskDoc::class);
