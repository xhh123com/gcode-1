...
use App\MongoDB\Models\Doc\PatientPlanTemplateDoc;
use App\MongoDB\Models\PatientPlanTemplate;
use Illuminate\Support\Facades\DB;

//该版本Manager主要支持MongoDB的数据模型
class PatientPlanTemplateManager
{
    ...
    */
    public static function getById($_id)
    {
        ...
        $info = PatientPlanTemplate::where('_id', $_id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = PatientPlanTemplate::withTrashed()->where('_id', $_id)->first();
        return $info;
    }
...
{
    $ref = new \ReflectionClass(PatientPlanTemplateDoc::class);
