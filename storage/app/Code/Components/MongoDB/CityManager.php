...
use App\MongoDB\Models\Doc\CityDoc;
use App\MongoDB\Models\City;
...
class CityManager
{
    ...
    */
    ...
    {
        $info = City::withTrashed()->where('_id', $_id)->first();
        return $info;
    }
    ...
    */
    public static function getListByCon($con_arr, $is_paginate, $page = 1)
    {
        ...
        if (array_key_exists('province_id', $con_arr) && !Utils::isObjNull($con_arr['province_id'])) {
        $infos = $infos->where('province_id', '=', $con_arr['province_id']);
        }
...
{
    $ref = new \ReflectionClass(CityDoc::class);
