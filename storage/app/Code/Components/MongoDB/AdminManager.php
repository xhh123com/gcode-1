...
use App\MongoDB\Models\Doc\AdminDoc;
use App\MongoDB\Models\Admin;
...
class AdminManager
{
    ...
    */
    public static function getById($_id)
    {
        ...
        $info = Admin::where('_id', $_id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = Admin::withTrashed()->where('_id', $_id)->first();
        return $info;
    }
...
{
    $ref = new \ReflectionClass(AdminDoc::class);
