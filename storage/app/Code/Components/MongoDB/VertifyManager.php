...
use App\MongoDB\Models\Doc\VertifyDoc;
use App\MongoDB\Models\Vertify;
...
class VertifyManager
{
    ...
    */
    public static function getById($_id)
    {
        ...
        $info = Vertify::where('_id', $_id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = Vertify::withTrashed()->where('_id', $_id)->first();
        return $info;
    }
...
{
    $ref = new \ReflectionClass(VertifyDoc::class);
