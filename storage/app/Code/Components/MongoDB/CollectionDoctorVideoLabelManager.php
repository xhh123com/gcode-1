...
use App\MongoDB\Models\Doc\CollectionDoctorVideoLabelDoc;
use App\MongoDB\Models\CollectionDoctorVideoLabel;
use Illuminate\Support\Facades\DB;

//该版本Manager主要支持MongoDB的数据模型
class CollectionDoctorVideoLabelManager
{
    ...
    */
    public static function getById($_id)
    {
        ...
        $info = CollectionDoctorVideoLabel::where('_id', $_id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = CollectionDoctorVideoLabel::withTrashed()->where('_id', $_id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $infos = new CollectionDoctorVideoLabel();
...
{
    $ref = new \ReflectionClass(CollectionDoctorVideoLabelDoc::class);
