...
use App\MongoDB\Models\Doc\FieldTemplateDoc;
use App\MongoDB\Models\FieldTemplate;
...
class FieldTemplateManager
{
    ...
    */
    public static function getById($_id)
    {
        ...
        $info = FieldTemplate::where('_id', $_id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = FieldTemplate::withTrashed()->where('_id', $_id)->first();
        return $info;
    }
...
{
    $ref = new \ReflectionClass(FieldTemplateDoc::class);
