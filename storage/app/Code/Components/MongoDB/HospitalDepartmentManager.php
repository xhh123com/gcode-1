...
use App\MongoDB\Models\Doc\HospitalDepartmentDoc;
use App\MongoDB\Models\HospitalDepartment;
...
class HospitalDepartmentManager
{
    ...
    */
    public static function getById($_id)
    {
        ...
        $info = HospitalDepartment::where('_id', $_id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = HospitalDepartment::withTrashed()->where('_id', $_id)->first();
        return $info;
    }
...
{
    $ref = new \ReflectionClass(HospitalDepartmentDoc::class);
