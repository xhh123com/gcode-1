...
use App\MongoDB\Models\Doc\NationalityDoc;
use App\MongoDB\Models\Nationality;
...
class NationalityManager
{
    ...
    */
    public static function getById($_id)
    {
        ...
        $info = Nationality::where('_id', $_id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = Nationality::withTrashed()->where('_id', $_id)->first();
        return $info;
    }
...
{
    $ref = new \ReflectionClass(NationalityDoc::class);
