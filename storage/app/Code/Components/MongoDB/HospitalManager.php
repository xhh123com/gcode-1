...
use App\MongoDB\Models\Doc\HospitalDoc;
use App\MongoDB\Models\Hospital;
...
class HospitalManager
{
    ...
    */
    public static function getById($_id)
    {
        ...
        $info = Hospital::where('_id', $_id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = Hospital::withTrashed()->where('_id', $_id)->first();
        return $info;
    }
...
{
    $ref = new \ReflectionClass(HospitalDoc::class);
