...
use App\MongoDB\Models\Doc\FieldTypeDoc;
use App\MongoDB\Models\FieldType;
...
class FieldTypeManager
{
    ...
    */
    public static function getById($_id)
    {
        ...
        $info = FieldType::where('_id', $_id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = FieldType::withTrashed()->where('_id', $_id)->first();
        return $info;
    }
...
{
    $ref = new \ReflectionClass(FieldTypeDoc::class);
