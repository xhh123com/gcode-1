...
use App\MongoDB\Models\Doc\DoctorPatientRelDoc;
use App\MongoDB\Models\DoctorPatientRel;
use Illuminate\Support\Facades\DB;

//该版本Manager主要支持MongoDB的数据模型
class DoctorPatientRelManager
{
    ...
    */
    public static function getById($_id)
    {
        ...
        $info = DoctorPatientRel::where('_id', $_id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = DoctorPatientRel::withTrashed()->where('_id', $_id)->first();
        return $info;
    }
...
{
    $ref = new \ReflectionClass(DoctorPatientRelDoc::class);
