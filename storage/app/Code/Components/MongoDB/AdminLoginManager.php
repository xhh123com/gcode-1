...
use App\MongoDB\Models\Doc\AdminLoginDoc;
use App\MongoDB\Models\AdminLogin;
...
class AdminLoginManager
{
    ...
    */
    public static function getById($_id)
    {
        ...
        $info = AdminLogin::where('_id', $_id)->first();
        return $info;
    }
    ...
    */
    ...
    {
        $info = AdminLogin::withTrashed()->where('_id', $_id)->first();
        return $info;
    }
...
{
    $ref = new \ReflectionClass(AdminLoginDoc::class);
