...
class ShopSettlementController
{
    ...
    */
    public function index(Request $request)
    {
        ...
        $shop_settlements =ShopSettlementManager::getListByCon($con_arr, true);
        foreach ($shop_settlements as $shop_settlement) {
        $shop_settlement = ShopSettlementManager::getInfoByLevel($shop_settlement, '');
        }

        return view('admin.shopSettlement.index', ['self_admin' => $self_admin, 'datas' => $shop_settlements, 'con_arr' => $con_arr]);
    }
    ...
    */
    public function edit(Request $request)
    {
        ...
        return view('admin.shopSettlement.edit', ['self_admin' => $self_admin, 'data' => $shop_settlement, 'upload_token' => $upload_token]);
    }
    ...
    */
    public function info(Request $request)
    {
        ...
        //信息
        $shop_settlement = ShopSettlementManager::getById($data['id']);
        $shop_settlement = ShopSettlementManager::getInfoByLevel($shop_settlement, '0');

        return view('admin.shopSettlement.info', ['self_admin' => $self_admin, 'data' => $shop_settlement]);
    }
