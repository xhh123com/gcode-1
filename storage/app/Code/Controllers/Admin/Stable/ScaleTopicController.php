...
class ScaleTopicController
{
    ...
    */
    public function index(Request $request)
    {
        ...
        $scale_topics =ScaleTopicManager::getListByCon($con_arr, true);
        foreach ($scale_topics as $scale_topic) {
        $scale_topic = ScaleTopicManager::getInfoByLevel($scale_topic, '');
        }

        return view('admin.scaleTopic.index', ['self_admin' => $self_admin, 'datas' => $scale_topics, 'con_arr' => $con_arr]);
    }
    ...
    */
    public function edit(Request $request)
    {
        ...
        return view('admin.scaleTopic.edit', ['self_admin' => $self_admin, 'data' => $scale_topic, 'upload_token' => $upload_token]);
    }
    ...
    */
    public function info(Request $request)
    {
        ...
        //信息
        $scale_topic = ScaleTopicManager::getById($data['id']);
        $scale_topic = ScaleTopicManager::getInfoByLevel($scale_topic, '0');

        return view('admin.scaleTopic.info', ['self_admin' => $self_admin, 'data' => $scale_topic]);
    }
