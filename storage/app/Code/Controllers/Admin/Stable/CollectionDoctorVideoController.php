...
class CollectionDoctorVideoController
{
    ...
    */
    public function index(Request $request)
    {
        ...
        $collection_doctor_videos =CollectionDoctorVideoManager::getListByCon($con_arr, true);
        foreach ($collection_doctor_videos as $collection_doctor_video) {
        $collection_doctor_video = CollectionDoctorVideoManager::getInfoByLevel($collection_doctor_video, '');
        }

        return view('admin.collectionDoctorVideo.index', ['self_admin' => $self_admin, 'datas' => $collection_doctor_videos, 'con_arr' => $con_arr]);
    }
    ...
    */
    public function edit(Request $request)
    {
        ...
        return view('admin.collectionDoctorVideo.edit', ['self_admin' => $self_admin, 'data' => $collection_doctor_video, 'upload_token' => $upload_token]);
    }
    ...
    */
    public function info(Request $request)
    {
        ...
        //信息
        $collection_doctor_video = CollectionDoctorVideoManager::getById($data['id']);
        $collection_doctor_video = CollectionDoctorVideoManager::getInfoByLevel($collection_doctor_video, '0');

        return view('admin.collectionDoctorVideo.info', ['self_admin' => $self_admin, 'data' => $collection_doctor_video]);
    }
