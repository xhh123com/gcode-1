...
class CommentController
{
    ...
    */
    public function index(Request $request)
    {
        ...
        $comment = CommentManager::getInfoByLevel($comment, '');
        }

        return view('admin.comment.index', ['self_admin' => $self_admin, 'datas' => $comments, 'con_arr' => $con_arr]);
    }
    ...
    */
    public function edit(Request $request)
    {
        ...
        return view('admin.comment.edit', ['self_admin' => $self_admin, 'data' => $comment, 'upload_token' => $upload_token]);
    }
    ...
    */
    public function deleteById(Request $request, $id)
    {
        ...
        CommentManager::deleteById($comment->id);
    ...
    */
    public function info(Request $request)
    {
        ...
        return view('admin.comment.info', ['self_admin' => $self_admin, 'data' => $comment]);
    }
