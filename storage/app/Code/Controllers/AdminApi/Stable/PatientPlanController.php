...
class PatientPlanController
{
    ...
    */
    public function getById(Request $request)
    {
        ...
        if($patient_plan){
            ...
            $patient_plan = PatientPlanManager::getInfoByLevel($patient_plan,$level);
        }
    ...
    */
    public function getListByCon(Request $request)
    {
        ...
        $patient_plans = PatientPlanManager::getListByCon($con_arr, $is_paginate);
        foreach ($patient_plans as $patient_plan) {
            $patient_plan = PatientPlanManager::getInfoByLevel($patient_plan, $level);
        }

        return ApiResponse::makeResponse(true, $patient_plans, ApiResponse::SUCCESS_CODE);
    }
