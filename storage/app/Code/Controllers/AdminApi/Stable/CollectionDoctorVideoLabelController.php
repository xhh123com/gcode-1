...
class CollectionDoctorVideoLabelController
{
    ...
    */
    public function getById(Request $request)
    {
        ...
        if($collection_doctor_video_label){
            ...
            $collection_doctor_video_label = CollectionDoctorVideoLabelManager::getInfoByLevel($collection_doctor_video_label,$level);
        }
    ...
    */
    public function getListByCon(Request $request)
    {
        ...
        $collection_doctor_video_labels = CollectionDoctorVideoLabelManager::getListByCon($con_arr, $is_paginate);
        foreach ($collection_doctor_video_labels as $collection_doctor_video_label) {
            $collection_doctor_video_label = CollectionDoctorVideoLabelManager::getInfoByLevel($collection_doctor_video_label, $level);
        }

        return ApiResponse::makeResponse(true, $collection_doctor_video_labels, ApiResponse::SUCCESS_CODE);
    }
