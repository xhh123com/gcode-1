...
class UserShopClerkApplyController
{
    ...
    */
    public function getById(Request $request)
    {
        ...
        if($user_shop_clerk_apply){
            ...
            $user_shop_clerk_apply = UserShopClerkApplyManager::getInfoByLevel($user_shop_clerk_apply,$level);
        }
    ...
    */
    public function getListByCon(Request $request)
    {
        ...
        $user_shop_clerk_applys = UserShopClerkApplyManager::getListByCon($con_arr, $is_paginate);
        foreach ($user_shop_clerk_applys as $user_shop_clerk_apply) {
            $user_shop_clerk_apply = UserShopClerkApplyManager::getInfoByLevel($user_shop_clerk_apply, $level);
        }

        return ApiResponse::makeResponse(true, $user_shop_clerk_applys, ApiResponse::SUCCESS_CODE);
    }
