...
class ScoreRuleController
{
    ...
    */
    public function getById(Request $request)
    {
        ...
        if($score_rule){
            ...
            $score_rule = ScoreRuleManager::getInfoByLevel($score_rule,$level);
        }
    ...
    */
    public function getListByCon(Request $request)
    {
        ...
        $score_rules = ScoreRuleManager::getListByCon($con_arr, $is_paginate);
        foreach ($score_rules as $score_rule) {
            $score_rule = ScoreRuleManager::getInfoByLevel($score_rule, $level);
        }

        return ApiResponse::makeResponse(true, $score_rules, ApiResponse::SUCCESS_CODE);
    }
