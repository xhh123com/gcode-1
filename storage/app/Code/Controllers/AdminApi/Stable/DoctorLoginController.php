...
class DoctorLoginController
{
    ...
    */
    public function getById(Request $request)
    {
        ...
        if($doctor_login){
            ...
            $doctor_login = DoctorLoginManager::getInfoByLevel($doctor_login,$level);
        }
    ...
    */
    public function getListByCon(Request $request)
    {
        ...
        $doctor_logins = DoctorLoginManager::getListByCon($con_arr, $is_paginate);
        foreach ($doctor_logins as $doctor_login) {
            $doctor_login = DoctorLoginManager::getInfoByLevel($doctor_login, $level);
        }

        return ApiResponse::makeResponse(true, $doctor_logins, ApiResponse::SUCCESS_CODE);
    }
