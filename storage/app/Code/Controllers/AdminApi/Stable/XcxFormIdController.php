...
class XcxFormIdController
{
    ...
    */
    public function getById(Request $request)
    {
        ...
        if($xcx_formId){
            ...
            $xcx_formId = XcxFormIdManager::getInfoByLevel($xcx_formId,$level);
        }
    ...
    */
    public function getListByCon(Request $request)
    {
        ...
        $xcx_formIds = XcxFormIdManager::getListByCon($con_arr, $is_paginate);
        foreach ($xcx_formIds as $xcx_formId) {
            $xcx_formId = XcxFormIdManager::getInfoByLevel($xcx_formId, $level);
        }

        return ApiResponse::makeResponse(true, $xcx_formIds, ApiResponse::SUCCESS_CODE);
    }
