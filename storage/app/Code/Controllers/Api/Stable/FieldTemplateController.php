...
class FieldTemplateController
{
    ...
    */
    public function getById(Request $request)
    {
        ...
        if($field_template){
            ...
            $field_template = FieldTemplateManager::getInfoByLevel($field_template,$level);
        }
    ...
    */
    public function getListByCon(Request $request)
    {
        ...
        $field_templates = FieldTemplateManager::getListByCon($con_arr, $is_paginate);
        foreach ($field_templates as $field_template) {
            $field_template = FieldTemplateManager::getInfoByLevel($field_template, $level);
        }

        return ApiResponse::makeResponse(true, $field_templates, ApiResponse::SUCCESS_CODE);
    }
}
