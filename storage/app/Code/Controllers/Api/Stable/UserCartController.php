...
class UserCartController
{
    ...
    */
    public function getById(Request $request)
    {
        ...
        if($user_cart){
            ...
            $user_cart = UserCartManager::getInfoByLevel($user_cart,$level);
        }
    ...
    */
    public function getListByCon(Request $request)
    {
        ...
        $user_carts = UserCartManager::getListByCon($con_arr, $is_paginate);
        foreach ($user_carts as $user_cart) {
            $user_cart = UserCartManager::getInfoByLevel($user_cart, $level);
        }

        return ApiResponse::makeResponse(true, $user_carts, ApiResponse::SUCCESS_CODE);
    }
}
