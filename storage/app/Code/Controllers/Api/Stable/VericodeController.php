...
class VericodeController
{
    ...
    */
    public function getById(Request $request)
    {
        ...
        if($vericode){
            ...
            $vericode = VericodeManager::getInfoByLevel($vericode,$level);
        }
    ...
    */
    public function getListByCon(Request $request)
    {
        ...
        $vericodes = VericodeManager::getListByCon($con_arr, $is_paginate);
        foreach ($vericodes as $vericode) {
            $vericode = VericodeManager::getInfoByLevel($vericode, $level);
        }

        return ApiResponse::makeResponse(true, $vericodes, ApiResponse::SUCCESS_CODE);
    }
}
