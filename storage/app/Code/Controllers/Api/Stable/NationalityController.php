...
class NationalityController
{
    ...
    */
    public function getById(Request $request)
    {
        ...
        if($nationality){
            ...
            $nationality = NationalityManager::getInfoByLevel($nationality,$level);
        }
    ...
    */
    public function getListByCon(Request $request)
    {
        ...
        $nationalitys = NationalityManager::getListByCon($con_arr, $is_paginate);
        foreach ($nationalitys as $nationality) {
            $nationality = NationalityManager::getInfoByLevel($nationality, $level);
        }

        return ApiResponse::makeResponse(true, $nationalitys, ApiResponse::SUCCESS_CODE);
    }
}
