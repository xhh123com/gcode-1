...
class FieldTypeController
{
    ...
    */
    public function getById(Request $request)
    {
        ...
        if($field_type){
            ...
            $field_type = FieldTypeManager::getInfoByLevel($field_type,$level);
        }
    ...
    */
    public function getListByCon(Request $request)
    {
        ...
        $field_types = FieldTypeManager::getListByCon($con_arr, $is_paginate);
        foreach ($field_types as $field_type) {
            $field_type = FieldTypeManager::getInfoByLevel($field_type, $level);
        }

        return ApiResponse::makeResponse(true, $field_types, ApiResponse::SUCCESS_CODE);
    }
}
