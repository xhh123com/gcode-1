...
class EasemobUserController
{
    ...
    */
    public function getById(Request $request)
    {
        ...
        if($easemob_user){
            ...
            $easemob_user = EasemobUserManager::getInfoByLevel($easemob_user,$level);
        }
    ...
    */
    public function getListByCon(Request $request)
    {
        ...
        $easemob_users = EasemobUserManager::getListByCon($con_arr, $is_paginate);
        foreach ($easemob_users as $easemob_user) {
            $easemob_user = EasemobUserManager::getInfoByLevel($easemob_user, $level);
        }

        return ApiResponse::makeResponse(true, $easemob_users, ApiResponse::SUCCESS_CODE);
    }
}
